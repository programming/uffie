...
<head>
    ...
    <link rel="stylesheet" href="templates/ellie/dist/css/style.css">
...
<body class="is-boxed">
						...
						<div class="hero-copy">
							...
							<div class="hero-form field field-grouped is-revealing">
	                            <div class="control control-expanded">
	                                ...
	                                <input class="button button-primary button-block button-shadow" type="submit" value="Submit Offer"><br /><br />
					                </form>
	                            </div>
	                        </div>
						</div>
    ...
    <script src="templates/ellie/dist/js/main.min.js"></script>
</body>
</html>
